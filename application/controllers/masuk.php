...
class masuk extends CI_Controller{
	...
	public function getData(){
		$jumlah_data = $this->model_masuk->jumlah_data();
	    $config['base_url'] = base_url().'index.php/masuk/getData/';
	    ...
	    $data['qmasuk'] = $this->model_masuk->data($config['per_page'],$from);
		$this->load->view('vmasuk',$data);
	}

	public function tambahData(){
		if($this->input->post('submit')){
			$this->model_masuk->tambah();
			$msg = "<div class='alert alert-success'> Data successfully inserted.</div>";
        	$this->session->set_flashdata("msg", $msg); 
			redirect('masuk/getData');
		}

		$data['kategori'] = $this->model_masuk->getKategori();
		$this->load->view('vformmasuk',$data);
	}

	public function edit($kode){
		$where = array('kode_barang' => $kode);
		$data['edit_masuk'] = $this->model_masuk->edit_data($where,'barang')->result();
		$data['kategori'] = $this->model_masuk->getKategori();
		$this->load->view('vdetmasuk',$data);
	}
	...
	public function update(){
		...
		$this->model_masuk->update_data($where,$data,'barang');
	...
	public function delete($id){
		...
		$this->model_masuk->delete($where,'barang');
	...
	function cariData(){
        ...
        $data['qmasuk']=$this->model_masuk->search($keyword);
        $this->load->view('vmasuk',$data);
    }
}
