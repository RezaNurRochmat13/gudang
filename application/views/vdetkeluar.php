...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="glyphicon glyphicon-th-list"></i>Data Barang Keluar</a></li>
...
<div class="panel panel-default">
  <div class="panel-heading"><b>Form Update Data Barang Keluar</b></div>
  <div class="panel-body">
    <?php foreach ($edit_keluar as $u) { ?>
    <form action="<?php echo base_url(). 'index.php/keluar/update'; ?>" method="post">
         <table class="table table-striped" height="420px">
         <tr>
          <td>
            <div class="form-group-row">
              ...
              <div class="col-xs-10">
                <div class="right-inner-addon">
                  <input type="hidden" name="kode_barang" value="<?php echo $u->kode_barang ?>">
                  <i class="glyphicon glyphicon-pencil"></i><input type="text" name="nama_barang" class="form-control" value="<?php echo $u->nama_barang?>">
                </div>
            </div>
            </td>
         </tr>
        <tr>
          <td>
            <div class="form-group-row">
              ...
              <div class="col-xs-10">
                <div class="right-inner-addon">
                     <i class="glyphicon glyphicon-calendar"></i><input type="text" name="tanggal_perolehan_barang" id="datepicker" class="form-control" value="<?php echo $u->tanggal_perolehan_barang?>">
                   </div>
                </div>
            </div>
          </td>
          ...
          <td>
            <div class="form-group-row">
              ...
              <div class="col-xs-10">
                <div class="right-inner-addon">
                    <i class="glyphicon glyphicon-usd"></i><input type="text" name="harga_perolehan_barang" class="form-control" value="<?php echo $u->harga_perolehan_barang?>">
                </div>
              </div>
          </div>
          </td>
            ...
            <div class="form-group-row">
              ...
              <div class="col-xs-10">
                    <div class="form-group">
                      <select class="selectpicker form-control" name="kode_kategori_barang" value="<?php echo $u->kode_kategori_barang?>">
                      <?php 
