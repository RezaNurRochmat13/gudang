...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="glyphicon glyphicon-th-list"></i>Kategori Barang</a></li>
...
<div class="panel panel-default">
  <div class="panel-heading"><b>Form Update Kategori Barang</b></div>
  <div class="panel-body">
     <?php foreach ($edit as $u) { ?>
     <form action="<?php echo base_url(). 'index.php/kategoriBarang/update';?>" method="post">
       <table class="table table-striped">
        <tr>
          <td>
            <div class="form-group-row">
                <label for="example-text-input" class="col-xs-2 col-form-label">Nama Kategori Barang</label>
                <div class="col-xs-10">
                  <div class="right-inner-addon">
                      <input type="hidden" name="kode_kategori_barang" value="<?php echo $u->kode_kategori_barang ?>">
                      <i class="glyphicon glyphicon-pencil"></i><input type="text" name="nama_kategori_barang" class="form-control" value="<?php echo $u->nama_kategori_barang?>">
                  </div>
            </div>
          </div>
            </td>
