...
<head>
  ...
  <title>Sistem Informasi Gudang PT Aino Indonesia</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="glyphicon glyphicon-th-list"></i>Data Pengguna</a></li>
...
<div class="panel panel-default">
  <div class="panel-heading"><b>Form Update Data User</b></div>
  <div class="panel-body">
     <?php foreach ($edit_pengguna as $u) { ?>
            ...
            <div class="form-group-row">
                ...
                <div class="col-xs-10">
                  <div class="right-inner-addon">
                      <input type="hidden" name="id_pengguna" value="<?php echo $u->id_pengguna?>">
                      <i class="glyphicon glyphicon-pencil"></i><input type="text" name="nama_pengguna" class="form-control" value="<?php echo $u->nama_pengguna?>">
                  </div>
            </div>
          </div>
            </td>
        ...
        <tr>
          <td>
            <div class="form-group-row">
                ...
                <div class="col-xs-10">
                  <div class="right-inner-addon">
                      <i class="glyphicon glyphicon-pencil"></i><input type="password" name="password" class="form-control" value="<?php echo $u->password?>">
                  </div>
            </div>
          </div>
            </td>
