...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('hardware/getHardware');?>"><i class="glyphicon glyphicon-th-list"></i>Data Stok Barang</a></li>
  ...
  <div class="panel-heading"><b>Data Stok Barang</b></div>
