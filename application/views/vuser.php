...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('hardware/getHardware');?>"><i class="glyphicon glyphicon-th-list"></i>Data Pengguna</a></li>
  ...
  <div class="panel-heading"><b>Data Pengguna</b></div>
  <div class="panel-body">
    <a href="<?php echo site_url('user/tambahData')?>" class="btn btn-default"><i class="glyphicon glyphicon-plus"></i>Tambah Pengguna</a>
       <table class="table table-striped">
        ...
        <?php }else{
         ...
         <tr>
          ...
          <td>
            <?php echo anchor('user/edit/'.$data->id_pengguna,'<button type="button" class="btn btn-info"><i class="glyphicon glyphicon-pencil"></i>Ubah Password</button>');?>
           <?php echo anchor('user/delete/'.$data->id_pengguna,'<button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i>Hapus Pengguna</button>');?>
          </td>
         </tr>
        <?php }}?>
        </tbody>
