...
<div class="panel panel-default">
  <div class="panel-heading"><b>Form Update Data Barang Masuk</b></div>
  <div class="panel-body">
    <?php foreach ($edit_masuk as $u) { ?>
    <form action="<?php echo base_url(). 'index.php/masuk/update'; ?>" method="post">
              ...
              <div class="col-xs-10">
                    <div class="form-group">
                      <select class="selectpicker form-control" name="kode_kategori_barang" value="<?php echo $u->kode_kategori_barang?>">
                        ...
                        <option value="2">Peralatan RT</option>
                        <option value="3">Makanan Ringan</option>
                        <option value="4">Peralatan Sekolah</option>
                      </select>
                  </div>
              </div>
          </div>
