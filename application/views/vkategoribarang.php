...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('hardware/getHardware');?>"><i class="glyphicon glyphicon-th-list"></i>Kategori Barang</a></li>
        <li class="active">Lihat Data Kategori</li>
      </ol>
    </section>
  ...
  <div class="panel-body">
      <a href="<?php echo site_url('kategoriBarang/tambahKategori')?>" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-plus"></i>Tambah Kategori Barang</a>
       <table class="table table-striped">
        ...
        <tbody>
        <?php if(empty($qkategori)){ ?>
         <tr>
          <td colspan="6">Data tidak ditemukan</td>
         </tr>
        <?php }else{
          $no= $this->uri->segment('3') + 1;
          foreach($qkategori as $data){ $no;?>
         <tr>
          <td><?php echo $no++?></td>
          <td><?php echo $data->kode_kategori_barang?></td>
          <td><?php echo $data->nama_kategori_barang?></td>
          <td>
           <?php echo anchor('kategoriBarang/edit/'.$data->kode_kategori_barang,'<button type="button" class="btn btn-info"><i class="glyphicon glyphicon-pencil"></i>Edit Data</button>');?>
           <?php echo anchor('kategoriBarang/delete/'.$data->kode_kategori_barang,'<button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i>Hapus Data</button>');?>
          </td>
         </tr>
        <?php }}?>
        </tbody>
  ...
  <footer class="main-footer">
    ...
    <div class="pull-right hidden-xs">
      Developed By Coding Is Life KOMSI UGM
    </div>
    <!-- Default to the left -->
