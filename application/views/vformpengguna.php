...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="glyphicon glyphicon-th-user"></i>Data Pengguna</a></li>
...
<div class="panel panel-default">
  <div class="panel-heading"><b>Form Tambah Pengguna</b></div>
         ...
         <tr>
            ...
            <div class="form-group-row">
                ...
                <div class="col-xs-10">
                  <div class="right-inner-addon">
                    <i class="glyphicon glyphicon-pencil"></i><input type="text" name="nama_pengguna" class="form-control" placeholder="Masukkan nama pengguna" value="<?php echo set_value('nama_pengguna')?>">
                  </div>
            </div>
          </div>
            </td>
          ...
          <td>
            <div class="form-group-row">
                ...
                <div class="col-xs-10">
                  <div class="right-inner-addon">
                    <i class="glyphicon glyphicon-pencil"></i><input type="password" name="password" class="form-control" placeholder="Masukkan password" value="<?php echo set_value(md5('password'))?>">
                  </div>
            </div>
          </div>
            </td>
