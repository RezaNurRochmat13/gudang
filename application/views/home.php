            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-right">
                  <a href="<?php echo base_url('verifylogin')?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
...
$(function () { 
    $('#container').highcharts({
        ...
        title: {
            text: 'Data Gudang PT ABC Indonesia'
        },
        xAxis: {
          categories: ['Barang Rumah Tangga', 'Barang Sembako','Barang Sekolah']
        },
        yAxis: {
            title: {
                text: 'Jumlah Barang'
