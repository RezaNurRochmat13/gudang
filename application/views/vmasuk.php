...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('hardware/getHardware');?>"><i class="glyphicon glyphicon-th-list"></i>Data Barang Masuk</a></li>
  ...
  <div class="panel panel-default">
    <div class="panel-heading"><b>Data Barang Masuk</b></div>
        <div class="panel-body">
            <div class="col-md-7">
              <a href="<?php echo site_url('masuk/tambahData')?>" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-plus"></i>Tambah Data Barang</a>
            </div>
       ...
       <table class="table table-striped">
        ...
        <?php }else{
         ...
         <tr>
          ...
          <td>
              <?php echo anchor('masuk/edit/'.$data->kode_barang,'<button type="button" class="btn btn-info"><i class="glyphicon glyphicon-pencil"></i>Edit Data</button>');?>
              <?php echo anchor('masuk/delete/'.$data->kode_barang,'<button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i>Hapus Data</button>');?>
          </td>
         </tr>
        <?php }}?>
        </tbody>
