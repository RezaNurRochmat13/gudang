...
<div class="panel panel-default">
  <div class="panel-heading"><b>Form Tambah Kategori Barang</b></div>
  <div class="panel-body">
     <form action="<?php echo site_url("kategoriBarang/tambahKategori")?>" method="post">
            ...
            <div class="form-group-row">
                ...
                <div class="col-xs-10">
                  <div class="right-inner-addon">
                    <i class="glyphicon glyphicon-pencil"></i><input type="text" name="nama_kategori_barang" class="form-control" placeholder="Masukkan nama kategori" value="<?php echo set_value('nama_kategori_barang')?>">
                  </div>
            </div>
          </div>
            </td>
